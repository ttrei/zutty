...
const InputSpec is_Alt[] = {
    // UTF-8 encoded:
    {Key::K0, "\xc2\xb0"},        {Key::K1, "\xc2\xb1"},
    {Key::K2, "\xc2\xb2"},        {Key::K3, "\xc2\xb3"},
    {Key::K4, "\xc2\xb4"},        {Key::K5, "\xc2\xb5"},
    {Key::K6, "\xc2\xb6"},        {Key::K7, "\xc2\xb7"},
    {Key::K8, "\xc2\xb8"},        {Key::K9, "\xc2\xb9"},
    {Key::Backtick, "\xc3\xa0"},  {Key::Tilde, "\xc3\xbe"},
    {Key::Backspace, "\xc3\xbf"}, {Key::NONE, nullptr},
};

const InputSpec is_Alt_altSendsEscape[] = {
    {Key::K0, ESC "0"},           {Key::K1, ESC "1"},
    {Key::K2, ESC "2"},           {Key::K3, ESC "3"},
    {Key::K4, ESC "4"},           {Key::K5, ESC "5"},
    {Key::K6, ESC "6"},           {Key::K7, ESC "7"},
    {Key::K8, ESC "8"},           {Key::K9, ESC "9"},
    {Key::Backtick, ESC "`"},     {Key::Tilde, ESC "~"},
    {Key::Backspace, ESC "\x7f"}, {Key::Space, ESC " "},
    {Key::Tab, ESC "\t"},         {Key::Return, ESC "\n"},
    {Key::NONE, nullptr},
};

const InputSpec is_Control_modOtherKeys[] = {
    {Key::K0, CSI "27;" MC ";48~"}, {Key::K1, CSI "27;" MC ";49~"},
    {Key::K9, CSI "27;" MC ";57~"}, {Key::Tab, CSI "27;" MC ";9~"},
    {Key::NONE, nullptr},
};

const InputSpec is_ControlAlt_altSendsEscape[] = {
    {Key::K2, ESC "\x00", 2},    {Key::K3, ESC "\x1b", 2},
    {Key::K4, ESC "\x1c", 2},    {Key::K5, ESC "\x1d", 2},
    {Key::K6, ESC "\x1e", 2},    {Key::K7, ESC "\x1f", 2},
    {Key::K8, ESC "\x7f", 2},    {Key::Backtick, ESC "\x00", 2},
    {Key::Tilde, ESC "\x1e", 2}, {Key::Space, ESC "\x00", 2},
    {Key::NONE, nullptr},
};

const InputSpec is_Control[] = {
    {Key::K2, "\x00", 1},    {Key::K3, "\x1b", 1},
    {Key::K4, "\x1c", 1},    {Key::K5, "\x1d", 1},
    {Key::K6, "\x1e", 1},    {Key::K7, "\x1f", 1},
    {Key::K8, "\x7f", 1},    {Key::Backtick, "\x00", 1},
    {Key::Tilde, "\x1e", 1}, {Key::Space, "\x00", 1},
    {Key::NONE, nullptr},
};
...
const InputSpec is_Ansi[] = {
    ...
    {Key::Space, " "},       {Key::Backspace, "\x7f"},
    {Key::Tab, "\t"},        {Key::Return, "\r"},
    {Key::Insert, CSI "2~"}, {Key::Delete, CSI "3~"},
    {Key::PageUp, CSI "5~"}, {Key::PageDown, CSI "6~"},
    {Key::NONE, nullptr},
};

const InputSpec is_Mod_Ansi[] = {
    {Key::Insert, CSI "2;" MC "~"}, {Key::Delete, CSI "3;" MC "~"},
    {Key::PageUp, CSI "5;" MC "~"}, {Key::PageDown, CSI "6;" MC "~"},
    {Key::NONE, nullptr},
};

const InputSpec is_Ansi_FunctionKeys[] = {
    {Key::F1, SS3 "P"},    {Key::KP_F1, SS3 "P"}, {Key::F2, SS3 "Q"},
    {Key::KP_F2, SS3 "Q"}, {Key::F3, SS3 "R"},    {Key::KP_F3, SS3 "R"},
    {Key::F4, SS3 "S"},    {Key::KP_F4, SS3 "S"}, {Key::F5, CSI "15~"},
    {Key::F6, CSI "17~"},  {Key::F7, CSI "18~"},  {Key::F8, CSI "19~"},
    {Key::F9, CSI "20~"},  {Key::F10, CSI "21~"}, {Key::F11, CSI "23~"},
    {Key::F12, CSI "24~"}, {Key::F13, CSI "25~"}, {Key::F14, CSI "26~"},
    {Key::F15, CSI "28~"}, {Key::F16, CSI "29~"}, {Key::F17, CSI "31~"},
    {Key::F18, CSI "32~"}, {Key::F19, CSI "33~"}, {Key::F20, CSI "34~"},
    {Key::NONE, nullptr},
};
...
const InputSpec is_Mod_Ansi_FunctionKeys[] = {
    ...
    {Key::F5, CSI "15;" MC "~"},  {Key::F6, CSI "17;" MC "~"},
    {Key::F7, CSI "18;" MC "~"},  {Key::F8, CSI "19;" MC "~"},
    {Key::F9, CSI "20;" MC "~"},  {Key::F10, CSI "21;" MC "~"},
    {Key::F11, CSI "23;" MC "~"}, {Key::F12, CSI "24;" MC "~"},
    {Key::F13, CSI "25;" MC "~"}, {Key::F14, CSI "26;" MC "~"},
    {Key::F15, CSI "28;" MC "~"}, {Key::F16, CSI "29;" MC "~"},
    {Key::F17, CSI "31;" MC "~"}, {Key::F18, CSI "32;" MC "~"},
    {Key::F19, CSI "33;" MC "~"}, {Key::F20, CSI "34;" MC "~"},
    {Key::NONE, nullptr},
};

const InputSpec is_Ansi_KeypadKeys[] = {
    {Key::KP_Space, " "}, {Key::KP_Tab, "\t"},     {Key::KP_Enter, "\r"},
    {Key::KP_Star, "*"},  {Key::KP_Plus, "+"},     {Key::KP_Comma, ","},
    {Key::KP_Minus, "-"}, {Key::KP_Slash, "/"},    {Key::KP_Delete, "."},
    {Key::KP_Dot, "."},   {Key::KP_Insert, "0"},   {Key::KP_0, "0"},
    {Key::KP_End, "1"},   {Key::KP_1, "1"},        {Key::KP_Down, "2"},
    {Key::KP_2, "2"},     {Key::KP_PageDown, "3"}, {Key::KP_3, "3"},
    {Key::KP_Left, "4"},  {Key::KP_4, "4"},        {Key::KP_Begin, "5"},
    {Key::KP_5, "5"},     {Key::KP_Right, "6"},    {Key::KP_6, "6"},
    {Key::KP_Home, "7"},  {Key::KP_7, "7"},        {Key::KP_Up, "8"},
    {Key::KP_8, "8"},     {Key::KP_PageUp, "9"},   {Key::KP_9, "9"},
    {Key::KP_Equal, "="}, {Key::NONE, nullptr},
};

const InputSpec is_Appl_KeypadKeys[] = {
    {Key::KP_Space, SS3 " "},    {Key::KP_Tab, SS3 "I"},
    {Key::KP_Enter, SS3 "M"},    {Key::KP_Star, SS3 "j"},
    {Key::KP_Plus, SS3 "k"},     {Key::KP_Comma, SS3 "l"},
    {Key::KP_Minus, SS3 "m"},    {Key::KP_Delete, SS3 "n"},
    {Key::KP_Slash, SS3 "o"},    {Key::KP_Insert, SS3 "p"},
    {Key::KP_End, SS3 "q"},      {Key::KP_Down, SS3 "r"},
    {Key::KP_PageDown, SS3 "s"}, {Key::KP_Left, SS3 "t"},
    {Key::KP_Begin, SS3 "u"},    {Key::KP_Right, SS3 "v"},
    {Key::KP_Home, SS3 "w"},     {Key::KP_Up, SS3 "x"},
    {Key::KP_PageUp, SS3 "y"},   {Key::KP_Equal, SS3 "X"},
    {Key::NONE, nullptr},
};

const InputSpec is_Mod_Appl_KeypadKeys[] = {
    {Key::KP_Space, SS3 MC " "},    {Key::KP_Tab, SS3 MC "I"},
    {Key::KP_Enter, SS3 MC "M"},    {Key::KP_Star, SS3 MC "j"},
    {Key::KP_Plus, SS3 MC "k"},     {Key::KP_Comma, SS3 MC "l"},
    {Key::KP_Minus, SS3 MC "m"},    {Key::KP_Delete, SS3 MC "n"},
    {Key::KP_Slash, SS3 MC "o"},    {Key::KP_Insert, SS3 MC "p"},
    {Key::KP_End, SS3 MC "q"},      {Key::KP_Down, SS3 MC "r"},
    {Key::KP_PageDown, SS3 MC "s"}, {Key::KP_Left, SS3 MC "t"},
    {Key::KP_Begin, SS3 MC "u"},    {Key::KP_Right, SS3 MC "v"},
    {Key::KP_Home, SS3 MC "w"},     {Key::KP_Up, SS3 MC "x"},
    {Key::KP_PageUp, SS3 MC "y"},   {Key::KP_Equal, SS3 MC "X"},
    {Key::NONE, nullptr},
};

const InputSpec is_VT52_KeypadKeys[] = {
    {Key::KP_Space, ESC "? "},    {Key::KP_Tab, ESC "?I"},
    {Key::KP_Enter, ESC "?M"},    {Key::KP_Star, ESC "?j"},
    {Key::KP_Plus, ESC "?k"},     {Key::KP_Comma, ESC "?l"},
    {Key::KP_Minus, ESC "?m"},    {Key::KP_Delete, ESC "?n"},
    {Key::KP_Slash, ESC "?o"},    {Key::KP_Insert, ESC "?p"},
    {Key::KP_End, ESC "?q"},      {Key::KP_Down, ESC "?r"},
    {Key::KP_PageDown, ESC "?s"}, {Key::KP_Left, ESC "?t"},
    {Key::KP_Begin, ESC "?u"},    {Key::KP_Right, ESC "?v"},
    {Key::KP_Home, ESC "?w"},     {Key::KP_Up, ESC "?x"},
    {Key::KP_PageUp, ESC "?y"},   {Key::KP_Equal, ESC "?X"},
    {Key::NONE, nullptr},
};

const InputSpec is_VT52_FunctionKeys[] = {
    {Key::F1, ESC "P"},    {Key::KP_F1, ESC "P"}, {Key::F2, ESC "Q"},
    {Key::KP_F2, ESC "Q"}, {Key::F3, ESC "R"},    {Key::KP_F3, ESC "R"},
    {Key::F4, ESC "S"},    {Key::KP_F4, ESC "S"}, {Key::NONE, nullptr},
};

const InputSpec is_Ansi_CursorKeys[] = {
    {Key::Up, CSI "A"},   {Key::Down, CSI "B"}, {Key::Right, CSI "C"},
    {Key::Left, CSI "D"}, {Key::Home, CSI "H"}, {Key::End, CSI "F"},
    {Key::NONE, nullptr},
};

const InputSpec is_Appl_CursorKeys[] = {
    {Key::Up, SS3 "A"},   {Key::Down, SS3 "B"}, {Key::Right, SS3 "C"},
    {Key::Left, SS3 "D"}, {Key::Home, SS3 "H"}, {Key::End, SS3 "F"},
    {Key::NONE, nullptr},
};

const InputSpec is_Mod_CursorKeys[] = {
    {Key::Up, CSI "1;" MC "A"},    {Key::Down, CSI "1;" MC "B"},
    {Key::Right, CSI "1;" MC "C"}, {Key::Left, CSI "1;" MC "D"},
    {Key::Home, CSI "1;" MC "H"},  {Key::End, CSI "1;" MC "F"},
    {Key::NONE, nullptr},
};

const InputSpec is_VT52_CursorKeys[] = {
    {Key::Up, ESC "A"},   {Key::Down, ESC "B"}, {Key::Right, ESC "C"},
    {Key::Left, ESC "D"}, {Key::Home, ESC "H"}, {Key::End, ESC "F"},
    {Key::NONE, nullptr},
};
...
inline uint8_t getModifierCode(VtModifier modifiers) {
  switch (modifiers) {
...
const uint16_t *Vterm::charCodes[] = {
    ...
    uc_DecSpec,  uc_DecSuppl,
    uc_DecSuppl, // Slot for 'User-preferred supplemental'
    uc_DecTechn, uc_IsoLatin1, uc_IsoUK};

Vterm::Vterm(uint16_t glyphPx_, uint16_t glyphPy_, uint16_t winPx_,
             uint16_t winPy_, int ptyFd_)
    : winPx(winPx_), winPy(winPy_), nCols((winPx - 2 * opts.border) / glyphPx_),
      nRows((winPy - 2 * opts.border) / glyphPy_), glyphPx(glyphPx_),
      glyphPy(glyphPy_), ptyFd(ptyFd_), onRefresh([](const Frame &) {}),
      ...
      frame_pri(winPx, winPy, nCols, nRows, marginTop, marginBottom,
                opts.saveLines),
      cf(&frame_pri), utf8dec([this]() { placeGraphicChar(); }),
      nColsEff(nCols), hMargin(0) {
...
void Vterm::setBellHandler(const BellHandlerFn &onBell_) { onBell = onBell_; }
...
void Vterm::resize(uint16_t winPx_, uint16_t winPy_) {
  ...
  if (altScreenBufferMode) {
    frame_alt = Frame(winPx, winPy, nCols_, nRows_, marginTop, marginBottom);
  } else {
    if (nRows_ < posY + 1) {
    ...
    frame_pri.resize(winPx, winPy, nCols_, nRows_, marginTop, marginBottom);
...
std::string Vterm::getLocalEcho(const unsigned char *const begin,
...
int Vterm::writePty(VtKey key, VtModifier modifiers_, bool userInput) {
  ...
  if (modifiers == VtModifier::none) {
    return writePty((const uint8_t *)spec.input, spec.getLength(), userInput);
  } else {
...
int Vterm::writePty(uint8_t ch, VtModifier modifiers, bool userInput) {
  ...
  const auto &mod2_encode = [&](uint8_t ch) {
    const char *exempt = "!#$%&*()-+=?.,:;<>'\"";
  ...
  if ((modifyOtherKeys == 2 && mod2_encode(ch)) ||
    ...
    if (altSendsEscape) {
      ...
      return writePty((const uint8_t *)utf8_out.data(), utf8_out.size(),
                      userInput);
    }
  } else {
...
Vterm::InputSpecTable *Vterm::getInputSpecTable() {
  static InputSpecTable ist[] = {
      {[this]() { return (autoNewlineMode == true); }, is_ReturnKey_ANL},
      ...
      {[this]() { return (modifyOtherKeys == 2 && modifiers != Mod::none); },
       is_modOtherKeys2},
      ...
      {[this]() { return ((modifiers & Mod::alt) != Mod::none); }, is_Alt},

      {[this]() { return ((modifiers & Mod::control) != Mod::none); },
       is_Control},

      {[this]() { return ((modifiers & Mod::shift) != Mod::none); }, is_Shift},

      {[this]() { return (bkspSendsDel == false); }, is_BackspaceKey_BkSp},
      ...
      {[this]() { return (keypadMode == KeypadMode::Application); },
       is_Appl_KeypadKeys},
      {[this]() { return (modifiers != Mod::none); }, is_Mod_CursorKeys},
      {[this]() { return (cursorKeyMode == CursorKeyMode::Application); },
       is_Appl_CursorKeys},

      {[this]() { return (modifiers != Mod::none); }, is_Mod_Ansi},
      {[this]() { return (modifiers != Mod::none); }, is_Mod_Ansi_FunctionKeys},
...
const Vterm::InputSpec *Vterm::selectInputSpecs() {
...
const Vterm::InputSpec &Vterm::getInputSpec(Key key) {
...
#define COLLECT_NUMERIC_PARAMS                                                 \
  ...
  case ';':                                                                    \
    if (nInputOps < maxEscOps)                                                 \
      ...
      logE << "inputOps full, increase maxEscOps (currently: " << maxEscOps    \
           << ")!" << std::endl;                                               \
      setState(InputState::Normal);                                            \
    }                                                                          \
    break
...
void Vterm::selectStart(int pX, int pY, bool cycleSnapTo) {
  logT << "selectStart (" << pX << "," << pY << "), cycleSnapTo=" << cycleSnapTo
       << std::endl;
